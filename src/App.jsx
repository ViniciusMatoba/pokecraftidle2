...
const NATURE_LIST = ['Adamant', 'Modest', 'Jolly', 'Timid', 'Bold', 'Calm', 'Impish', 'Careful', 'Brave', 'Quiet'];

const getMasteryPath = (pokemonId) => {
...
const getEffectiveStat = (pokemon, stat) => {
    ...
    <div className="app-shell">
      {(!loading && user) ? (
        <>
          ...
          <main className="flex-1 overflow-y-auto overscroll-contain p-4 w-full relative z-10 custom-scrollbar">
            {renderView()}
          </main>
        </>
      ) : (
