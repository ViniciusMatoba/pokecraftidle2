...
export const TrainerCard = ({ 
  ...
  const hasHoennProgress = worldFlags.includes('hoenn_started') || worldFlags.includes('hoenn_champion')
    || HOENN_BADGE_IDS.some(id => badges.includes(id) || worldFlags.includes(id));
