  ...
  return (
    <div className={`flex flex-col h-full animate-fadeIn pb-4 gap-2 overflow-y-auto custom-scrollbar ${screenShake ? 'battle-screen-shake' : ''}`} style={{paddingTop: '8px'}}>
      ...
      <div className="relative overflow-hidden rounded-2xl shadow-xl flex-shrink-0" style={{ height: 360 }}>
        ...
        <div ref={enemySpriteRef} className="absolute top-3 right-2 z-10 w-40 h-40 flex items-center justify-center">
          ...
          <div className="relative w-full h-full flex items-center justify-center" style={{ transform: `scale(${(currentEnemy.isTrainer && showTrainer) ? 1 : getSpriteScale(currentEnemy)})`, transition: 'transform 0.3s' }}>
        ...
        <div ref={playerSpriteRef} className="absolute bottom-1 left-2 z-10 w-40 h-40 flex items-center justify-center">
          ...
          {activePoke && (
            <div className="relative w-full h-full flex items-center justify-center" style={{ transform: `scale(${getSpriteScale(activePoke)})`, transition: 'transform 0.3s' }}>
              <div className="absolute -top-10 left-1/2 -translate-x-1/2 pointer-events-none z-20 whitespace-nowrap">
      ...
      {/* Contador de Pokébolas — logo abaixo da área de batalha */}
      {(() => {
