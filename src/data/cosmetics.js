...
export const AVATAR_SPRITES = {
  ...
  giovannirocket: {
    ...
    lockReason: 'Derrote Giovanni no Esconderijo da Rocket em Kanto',
    cost: 8000,
    description: 'Líder da Equipe Rocket. Desbloqueado ao limpar o Esconderijo da Rocket.',
  },
  blue_rival: {
    id: 'blue_rival',
    name: 'Azul',
  ...
  lorelei: {
    ...
    unlockFlag: 'rocket_silph_cleared',
    lockReason: 'Liberte a Silph Co. da Equipe Rocket em Kanto',
    cost: 12000,
    description: 'Mestra do Gelo da Elite 4 de Kanto. Desbloqueada ao limpar a Silph Co.',
  },
  ...
  silver_rival: {
    ...
    minBadges: 14,
    cost: 8000,
    description: 'O rival misterioso de Johto. Desbloqueado com 14 insígnias.',
  },
  lance: {
    id: 'lance',
    name: 'Lance',
  ...
  wally: {
    ...
    minBadges: 20,
    cost: 6000,
    description: 'O rival frágil que surpreende todos em Hoenn. Desbloqueado com 20 insígnias.',
  },
  steven: {
    id: 'steven',
    name: 'Steven',
  ...
  barry: {
    ...
    minBadges: 28,
    cost: 7000,
    description: 'O rival energético de Sinnoh. Desbloqueado com 28 insígnias.',
  },
  cynthia: {
    id: 'cynthia',
    name: 'Cynthia',
  ...
  cyrus: {
    ...
    lockReason: 'Derrote a Equipe Galáctica no Spear Pillar em Sinnoh',
    cost: 14000,
    description: 'Líder da Equipe Galáctica. Desbloqueado ao encerrar o plano no Spear Pillar.',
  },
  ...
  cheren: {
    ...
    minBadges: 36,
    cost: 6000,
    description: 'O rival estudioso de Unova. Desbloqueado com 36 insígnias.',
  },
  bianca: {
    id: 'bianca',
    name: 'Bianca',
    ...
    minBadges: 36,
    cost: 6000,
    description: 'A rival gentil de Unova. Desbloqueada com 36 insígnias.',
  },
  elesa: {
    id: 'elesa',
    name: 'Elesa',
    ...
    minBadges: 38,
    cost: 12000,
    description: 'Líder de ginásio e modelo famosa de Unova. Desbloqueada com 38 insígnias.',
  },
  iris_unova: {
    id: 'iris_unova',
    name: 'Iris',
  ...
  korrina: {
    ...
    minBadges: 42,
    cost: 10000,
    description: 'Mestra de Mega Evolução em Kalos. Desbloqueada com 42 insígnias.',
  },
  clemont_avatar: {
    id: 'clemont_avatar',
    name: 'Clemont',
    ...
    minBadges: 44,
    cost: 8000,
    description: 'Inventor e líder de ginásio de Lumiose City. Desbloqueado com 44 insígnias.',
  },
  lysandre_villain: {
    id: 'lysandre_villain',
    name: 'Lysandre',
  ...
  hau: {
    ...
    minBadges: 50,
    cost: 7000,
    description: 'O rival energético de Alola. Desbloqueado com 50 insígnias.',
  },
  lillie: {
    id: 'lillie',
    name: 'Lillie',
    ...
    minBadges: 52,
    cost: 10000,
    description: 'A amiga misteriosa do protagonista em Alola. Desbloqueada com 52 insígnias.',
  },
  gladion: {
    id: 'gladion',
    name: 'Gladion',
    ...
    minBadges: 54,
    cost: 12000,
    description: 'O rival sombrio irmão de Lillie. Desbloqueado com 54 insígnias.',
  },
  acerola: {
    id: 'acerola',
    name: 'Acerola',
    ...
    minBadges: 52,
    cost: 10000,
    description: 'Capitã do Trial de Ghost em Alola. Desbloqueada com 52 insígnias.',
  },
  guzma: {
    id: 'guzma',
    name: 'Guzma',
  ...
  hop: {
    ...
    minBadges: 58,
    cost: 7000,
    description: 'O irmão mais novo de Leon e rival em Galar. Desbloqueado com 58 insígnias.',
  },
  marnie: {
    id: 'marnie',
    name: 'Marnie',
    ...
    minBadges: 60,
    cost: 12000,
    description: 'A rival popular de Galar com fãs da Equipe Yell. Desbloqueada com 60 insígnias.',
  },
  marnie_league: {
    id: 'marnie_league',
    name: 'Marnie (Liga)',
  ...
  bea: {
    ...
    minBadges: 60,
    cost: 12000,
    description: 'Líder de ginásio de Fighting em Galar. Desbloqueada com 60 insígnias.',
  },
  nessa: {
    id: 'nessa',
    name: 'Nessa',
    ...
    minBadges: 60,
    cost: 12000,
    description: 'Líder de ginásio de Water em Galar. Desbloqueada com 60 insígnias.',
  },
  allister: {
    id: 'allister',
    name: 'Allister',
    ...
    minBadges: 60,
    cost: 12000,
    description: 'Líder de ginásio de Ghost em Galar. Desbloqueado com 60 insígnias.',
  },
  piers: {
    id: 'piers',
    name: 'Piers',
    ...
    minBadges: 62,
    cost: 12000,
    description: 'Líder de ginásio de Dark e vocalista em Galar. Desbloqueado com 62 insígnias.',
  },
  raihan: {
    id: 'raihan',
    name: 'Raihan',
    ...
    minBadges: 63,
    cost: 12000,
    description: 'O segundo melhor treinador de Galar. Desbloqueado com 63 insígnias.',
  },
  gloria_league: {
    id: 'gloria_league',
    name: 'Gloria (Liga)',
  ...
  nemona: {
    ...
    minBadges: 66,
    cost: 8000,
    description: 'A rival entusiasmada de Paldea. Desbloqueada com 66 insígnias.',
  },
  arven: {
    id: 'arven',
    name: 'Arven',
    ...
    minBadges: 66,
    cost: 8000,
    description: 'O rival chef de Paldea. Desbloqueado com 66 insígnias.',
  },
  iono: {
    id: 'iono',
    name: 'Iono',
    ...
    minBadges: 68,
    cost: 15000,
    description: 'Líder de ginásio e streamer famosa de Paldea. Desbloqueada com 68 insígnias.',
  },
  florian_festival: {
    id: 'florian_festival',
  ...
  kieran: {
    ...
    minBadges: 70,
    cost: 15000,
    description: 'O rival do DLC The Teal Mask. Desbloqueado com 70 insígnias.',
  },
  kieran_champion: {
    id: 'kieran_champion',
    name: 'Kieran Campeão',
  ...
  carmine: {
    ...
    minBadges: 70,
    cost: 12000,
    description: 'A irmã de Kieran do DLC The Teal Mask. Desbloqueada com 70 insígnias.',
  },
  geeta: {
    id: 'geeta',
    name: 'Geeta',
