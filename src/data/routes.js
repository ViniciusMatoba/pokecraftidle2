...
const FUTURE_REGION_ROUTES = {
  ...
  kalos_route_4: {
    ...
    unlockLevel: 12, requirements: ['kalos_route_2_cleared'], unlocks: 'kalos_route_5_cleared',
    biome: 'grass',
    enemies: [...pk([667, 669, 672, 674, 677, 680], 11), { id: 679, level: 17 }, { id: 682, level: 14 }, { id: 684, level: 14 }, { id: 694, level: 15 }, { id: 702, level: 13 }],
    trainerChance: 0.07,
    trainers: [{ name: 'Gardener Geoff', sprite: S.worker, team: pk([672, 673], 15), reward: 800 }],
  ...
  kalos_azure_bay: {
    ...
    biome: 'water',
    enemies: [...pk([690, 692, 131, 79, 193], 38), { id: 686, level: 35 }, { id: 688, level: 34 }],
    trainerChance: 0.09,
  ...
  kalos_frost_cavern: {
    ...
    biome: 'cave',
    enemies: [...pk([712, 714, 613, 615, 124, 220, 532, 633, 704], 46), { id: 708, level: 43 }, { id: 710, level: 43 }],
    trainerChance: 0.09,
  ...
  alola_ula_ula_island: {
    ...
    biome: 'grass',
    enemies: [...pk([766, 765, 769, 770, 778, 435, 675], 44), { id: 775, level: 42 }, { id: 777, level: 42 }],
    trainerChance: 0.09,
  ...
  galar_glimwood_tangle: {
    ...
    biome: 'forest',
    enemies: [...pk([854, 855, 876, 860, 852, 708], 38), { id: 859, level: 36 }, { id: 868, level: 35 }, { id: 885, level: 36 }],
    trainerChance: 0.09,
  ...
  galar_route_9: {
    ...
    biome: 'water',
    enemies: [...pk([872, 873, 874, 875, 882, 215], 48), { id: 846, level: 44 }, { id: 871, level: 44 }],
    trainerChance: 0.09,
  ...
  paldea_medali: {
    ...
    biome: 'grass',
    enemies: [...pk([924, 925, 971, 972, 983, 911], 40), { id: 957, level: 37 }, { id: 962, level: 37 }, { id: 963, level: 37 }],
    trainerChance: 0.09,
  ...
  paldea_glaseado_mountain: {
    ...
    biome: 'mountain',
    enemies: [...pk([974, 975, 998, 943, 633, 714], 50), { id: 950, level: 46 }, { id: 996, level: 46 }],
    trainerChance: 0.10,
