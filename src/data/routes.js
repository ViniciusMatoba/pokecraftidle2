...
const LEVEL_EVOLUTIONS = {
   ...
   268: { evolvesAt: 10, evolvesInto:  269 },
...
const FUTURE_REGION_ROUTES = {
  ...
  unova_route_3: {
    ...
    biome: 'grass',
    enemies: [...pk([519, 520, 522, 524, 517, 568], 16), { id: 531, level: 14 }, { id: 587, level: 16 }, { id: 590, level: 14 }, { id: 550, level: 16 }],
    trainerChance: 0.07,
  ...
  unova_pinwheel_forest: {
    ...
    biome: 'forest',
    enemies: [...pk([540, 543, 546, 548, 532, 535], 22), { id: 588, level: 18 }, { id: 616, level: 18 }],
    trainerChance: 0.08,
  ...
  unova_route_4: {
    ...
    biome: 'mountain',
    enemies: [...pk([551, 554, 557, 559, 561, 562], 30), { id: 574, level: 20 }, { id: 556, level: 22 }],
    trainerChance: 0.08,
  ...
  unova_chargestone_cave: {
    ...
    biome: 'cave',
    enemies: [...pk([524, 525, 595, 599, 601, 602], 36), { id: 527, level: 30 }, { id: 597, level: 30 }, { id: 577, level: 28 }],
    trainerChance: 0.09,
  ...
  unova_twist_mountain: {
    ...
    biome: 'mountain',
    enemies: [...pk([613, 615, 619, 525, 582, 583], 42), { id: 529, level: 36 }, { id: 605, level: 38 }, { id: 607, level: 36 }],
    trainerChance: 0.09,
  ...
  unova_route_9: {
    ...
    biome: 'grass',
    enemies: [...pk([610, 624, 569, 622, 626, 629, 633, 636], 48), { id: 538, level: 46 }, { id: 539, level: 46 }, { id: 572, level: 44 }, { id: 627, level: 46 }],
    trainerChance: 0.10,
  ...
  unova_victory_road: {
    ...
    biome: 'cave',
    enemies: [...pk([611, 612, 623, 625, 634], 56), { id: 570, level: 54 }, { id: 621, level: 56 }, { id: 631, level: 56 }, { id: 632, level: 56 }],
    trainerChance: 0.12,
  ...
  kalos_route_4: {
    ...
    biome: 'grass',
    enemies: [...pk([667, 669, 672, 674, 677, 680], 14), { id: 679, level: 24 }, { id: 682, level: 18 }, { id: 684, level: 18 }, { id: 694, level: 20 }, { id: 702, level: 18 }],
    trainerChance: 0.07,
  ...
  kalos_glittering_cave: {
    ...
    biome: 'cave',
    enemies: [...pk([696, 698, 66, 111, 303, 304, 597], 22), { id: 707, level: 28 }],
    trainerChance: 0.08,
  ...
  kalos_azure_bay: {
    ...
    biome: 'water',
    enemies: [...pk([690, 692, 131, 79, 193], 38), { id: 686, level: 26 }, { id: 688, level: 24 }],
    trainerChance: 0.09,
  ...
  kalos_frost_cavern: {
    ...
    biome: 'cave',
    enemies: [...pk([712, 714, 613, 615, 124, 220, 532, 633, 704], 46), { id: 708, level: 34 }, { id: 710, level: 34 }],
    trainerChance: 0.09,
  ...
  alola_akala_island: {
    ...
    biome: 'grass',
    enemies: [...pk([749, 751, 755, 757, 759, 761, 764], 20), { id: 753, level: 24 }, { id: 746, level: 22 }],
    trainerChance: 0.08,
  ...
  alola_aether_paradise: {
    ...
    biome: 'cave',
    enemies: [...pk([137, 82, 89, 568, 772, 773], 36), { id: 747, level: 26 }, { id: 771, level: 28 }, { id: 779, level: 30 }, { id: 781, level: 34 }],
    trainerChance: 0.09,
  ...
  alola_ula_ula_island: {
    ...
    biome: 'grass',
    enemies: [...pk([766, 765, 769, 770, 778, 435, 675], 44), { id: 775, level: 36 }, { id: 777, level: 34 }],
    trainerChance: 0.09,
  ...
  alola_vast_poni_canyon: {
    ...
    biome: 'mountain',
    enemies: [...pk([782, 783, 103, 621, 706, 780], 52), { id: 767, level: 40 }],
    trainerChance: 0.10,
  ...
  galar_mine_1: {
    ...
    biome: 'cave',
    enemies: [...pk([837, 838, 839, 50, 532], 20), { id: 878, level: 28 }],
    trainerChance: 0.08,
  ...
  galar_route_5: {
    ...
    biome: 'grass',
    enemies: [...pk([832, 843, 841, 856, 857, 870, 83], 28), { id: 848, level: 26 }, { id: 850, level: 24 }, { id: 845, level: 28 }],
    trainerChance: 0.08,
  ...
  galar_glimwood_tangle: {
    ...
    biome: 'forest',
    enemies: [...pk([854, 855, 876, 860, 852, 708], 38), { id: 859, level: 32 }, { id: 868, level: 30 }, { id: 885, level: 34 }],
    trainerChance: 0.09,
  ...
  galar_route_9: {
    ...
    biome: 'water',
    enemies: [...pk([872, 873, 874, 875, 882, 215], 48), { id: 846, level: 24 }, { id: 871, level: 30 }],
    trainerChance: 0.09,
  ...
  paldea_south_province: {
    ...
    biome: 'grass',
    enemies: [...pk([935, 936, 932, 924, 744, 669, 942], 12), { id: 919, level: 10 }],
    trainerChance: 0.07,
  ...
  paldea_artazon: {
    ...
    biome: 'grass',
    enemies: [...pk([948, 951, 946, 953, 938, 939], 20), { id: 926, level: 20 }, { id: 937, level: 18 }, { id: 940, level: 18 }],
    trainerChance: 0.08,
  ...
  paldea_asado_desert: {
    ...
    biome: 'mountain',
    enemies: [...pk([968, 960, 951, 946, 969], 30), { id: 927, level: 28 }, { id: 965, level: 32 }],
    trainerChance: 0.08,
  ...
  paldea_medali: {
    ...
    biome: 'grass',
    enemies: [...pk([924, 925, 971, 972, 983, 911], 40), { id: 957, level: 26 }, { id: 962, level: 28 }, { id: 963, level: 26 }],
    trainerChance: 0.09,
  ...
  paldea_glaseado_mountain: {
    ...
    biome: 'mountain',
    enemies: [...pk([974, 975, 998, 943, 633, 714], 50), { id: 950, level: 40 }, { id: 996, level: 38 }],
    trainerChance: 0.10,
...
const RAW_ROUTES = {
  ...
  route_5_6: {
    ...
    biome: 'grass',
    enemies: [...pk([16, 19, 52, 39, 96], 18), { id: 122, level: 20 }],
    trainerChance: 0.05,
    trainers: [
  ...
  route_7_8: {
    ...
    biome: 'grass',
    enemies: [...pk([58, 37, 43, 69, 96, 102, 52], 28), { id: 77, level: 28 }],
    trainerChance: 0.05,
    trainers: [
  ...
  seafoam_islands: {
    ...
    unlockLevel: 40, requirements: ['soul_badge'],
    biome: 'water',
    enemies: [...pk([79, 86, 87, 90, 91, 98, 124, 131, 144], 38), { id: 120, level: 38 }],
    trainerChance: 0,
    trainers: [],
  ...
  granite_cave: {
    ...
    biome: 'cave',
    enemies: [...pk([41, 293, 304, 299, 361], 10), { id: 296, level: 14 }],
    trainerChance: 0,
    trainers: [],
  ...
  route_111_desert: {
    ...
    biome: 'grass',
    enemies: [...pk([27, 28, 328, 329, 322, 290], 18), { id: 331, level: 26 }, { id: 343, level: 28 }],
    trainerChance: 0.05,
    trainers: [
  ...
  fiery_path: {
    ...
    biome: 'cave',
    enemies: [...pk([322, 218, 219, 109, 77], 20), { id: 324, level: 28 }, { id: 316, level: 26 }],
    trainerChance: 0,
    trainers: [],
  ...
  route_113: {
    ...
    unlockLevel: 22, requirements: ['dynamo_badge'],
    biome: 'grass',
    enemies: [...pk([333, 335, 227, 291], 20), { id: 327, level: 26 }],
    trainerChance: 0.05,
    trainers: [
  ...
  meteor_falls: {
    ...
    biome: 'cave',
    enemies: [...pk([333, 41, 304, 347, 348], 21), { id: 371, level: 30 }, { id: 337, level: 32 }, { id: 338, level: 32 }],
    trainerChance: 0.05,
    trainers: [
  ...
  mt_chimney: {
    ...
    biome: 'cave',
    enemies: [...pk([322, 323, 218, 219, 77, 78], 23), { id: 325, level: 26 }, { id: 307, level: 28 }],
    trainerChance: 0.07,
    trainers: [
  ...
  route_118_119: {
    ...
    biome: 'grass',
    enemies: [...pk([333, 335, 283, 284, 278, 341, 342], 28), { id: 315, level: 24 }, { id: 313, level: 22 }, { id: 314, level: 22 }],
    trainerChance: 0.05,
    trainers: [
  ...
  ocean_routes: {
    ...
    biome: 'water',
    enemies: [...pk([72, 73, 278, 279, 341, 342, 370, 369, 226], 40), { id: 320, level: 30 }, { id: 318, level: 28 }, { id: 339, level: 26 }, { id: 366, level: 32 }, { id: 349, level: 28 }, { id: 363, level: 32 }],
    trainerChance: 0.05,
    trainers: [
  ...
  eterna_forest_sinnoh: {
    ...
    biome: 'forest',
    enemies: [...pk([401, 402, 406, 315, 427, 433], 24), { id: 415, level: 24 }, { id: 455, level: 24 }],
    trainerChance: 0.08,
    trainers: [
  ...
  sinnoh_route_209: {
    ...
    biome: 'grass',
    enemies: [...pk([397, 400, 402, 427, 433, 434], 32), { id: 425, level: 32 }, { id: 449, level: 32 }],
    trainerChance: 0.08,
    trainers: [
  ...
  valor_lakefront: {
    ...
    biome: 'water',
    enemies: [...pk([398, 400, 405, 419, 423, 435], 42), { id: 422, level: 42 }, { id: 451, level: 42 }],
    trainerChance: 0.08,
    trainers: [
  ...
  mt_coronet_sinnoh: {
    ...
    biome: 'mountain',
    enemies: [...pk([398, 400, 405, 437, 444, 459], 54), { id: 447, level: 54 }],
    trainerChance: 0.08,
    trainers: [
  ...
  sunyshore_routes: {
    ...
    biome: 'grass',
    enemies: [...pk([398, 405, 407, 419, 448, 445], 76), { id: 431, level: 76 }],
    trainerChance: 0.09,
    trainers: [
