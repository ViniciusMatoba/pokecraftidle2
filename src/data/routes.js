...
export const ROUTES = {
  ...
  viridian_forest: {
    ...
    biome: 'forest',
    enemies: pkRange([10, 13, 11, 14], 5, 8),
    trainerChance: 0.05,
    trainers: [
  ...
  rock_tunnel: {
    ...
    biome: 'mountain',
    enemies: pkRange([74, 41, 95, 66], 28, 34),
    trainerChance: 0.05,
    trainers: [
  ...
  route_7_8: {
    ...
    biome: 'grass',
    enemies: pkRange([58, 37, 43, 69, 96, 102, 52], 34, 40),
    trainerChance: 0.05,
    trainers: [
  ...
  pokemon_mansion: {
    ...
    biome: 'mountain',
    enemies: pkRange([88, 109, 126, 132, 89], 48, 56),
    trainerChance: 0.05,
    trainers: [
  ...
  route_22_23: {
    ...
    biome: 'grass',
    enemies: pkRange([22, 23, 67, 105, 148], 50, 58),
    trainerChance: 0.05,
    trainers: [
  ...
  victory_road: {
    ...
    biome: 'mountain',
    enemies: pkRange([95, 67, 105, 112, 148, 146], 58, 66),
    trainerChance: 0.05,
    trainers: [
  ...
  route_11: {
    ...
    biome: 'grass',
    enemies: pkRange([21, 23, 19, 50, 60, 83, 84], 24, 32),
    trainerChance: 0.05,
    trainers: [
  ...
  seafoam_islands: {
    ...
    unlockLevel: 40, requirements: ['soul_badge'],
    biome: 'water',
    enemies: pkRange([79, 86, 87, 90, 91, 98, 124, 131, 144], 48, 58),
    trainerChance: 0,
    trainers: [],
  ...
  power_plant: {
    ...
    biome: 'mountain',
    enemies: pkRange([81, 82, 100, 101, 125, 135, 145], 38, 50),
    trainerChance: 0,
    trainers: [],
  ...
  route_23: {
    ...
    biome: 'grass',
    enemies: pkRange([22, 23, 67, 105, 148, 147], 60, 68),
    trainerChance: 0.05,
    trainers: [
