...
export const EXPEDITION_BIOMES = {
  ...
  floresta: {
    ...
    bg: "bg_expedition_floresta.webp",
  ...
  campo_lutador: {
    ...
    bg: "bg_expedition_campo_lutador.webp",
  ...
  pradaria: {
    ...
    bg: "bg_expedition_pradaria.webp",
  ...
  torre_fantasma: {
    ...
    bg: "bg_expedition_torre_fantasma.webp",
  ...
  templo_psiquico: {
    ...
    bg: "bg_expedition_templo_psiquico.webp",
  ...
  selva_dragao: {
    ...
    bg: "bg_expedition_selva_dragao.webp",
  ...
  johto_ilex: {
    ...
    bg: "bg_expedition_ilex_forest.webp", description: 'Madeira sagrada, Apricorns e essencias de Johto.',
  ...
  johto_whirl_islands: {
    ...
    bg: "bg_expedition_whirl_islands.webp", description: 'Cavernas marinhas para coletar recursos aquaticos raros.',
  ...
  hoenn_meteor_falls: {
    ...
    bg: "bg_expedition_meteor_falls.webp", description: 'Minerios, poeira mistica e fragmentos de meteorito.',
  ...
  hoenn_sky_pillar: {
    ...
    bg: "bg_expedition_sky_pillar.webp", description: 'Expedicao de elite para escamas, penas e materiais draconicos.',
  ...
  sinnoh_mt_coronet: {
    ...
    bg: "bg_expedition_sinnoh_mt_coronet.webp", description: 'Nucleo mineral de Sinnoh com drops para forja avancada.',
  ...
  sinnoh_stark_mountain: {
    ...
    bg: "bg_expedition_sinnoh_stark_mountain.webp", description: 'Area pos-Liga para materials de boss e treino de nivel 100.',
  ...
  unova_pinwheel: {
    ...
    bg: "bg_expedition_unova_pinwheel.webp", description: 'Estrutura preparada para Unova e quinta geracao.',
  ...
  kalos_reflection_cave: {
    ...
    bg: "bg_expedition_kalos_reflection.webp", description: 'Estrutura preparada para Kalos e sexta geracao.',
  ...
  alola_akala: {
    ...
    bg: "bg_expedition_alola_akala.webp", description: 'Estrutura preparada para Alola e setima geracao.',
  ...
  galar_wild_area: {
    ...
    bg: "bg_expedition_galar_wildarea.webp", description: 'Estrutura preparada para Galar e oitava geracao.',
  ...
  paldea_area_zero: {
    ...
    bg: "bg_expedition_paldea_areazero.webp", description: 'Estrutura preparada para Paldea e nona geracao.',
