...
export const EXPEDITION_BIOMES = {
  ...
  floresta: {
    ...
    bg: expBg('expedition_floresta.webp', '#1a3a1a'),
  ...
  oceano: {
    ...
    bg: expBg('expedition_oceano.webp', '#0a2a4a'),
  ...
  campo_lutador: {
    ...
    bg: expBg('expedition_campo_lutador.webp', '#3a2a1a'),
  ...
  pradaria: {
    ...
    bg: expBg('expedition_pradaria.webp', '#1a3a1a'),
  ...
  torre_fantasma: {
    ...
    bg: expBg('expedition_torre_fantasma.webp', '#1a0a2a'),
  ...
  templo_psiquico: {
    ...
    bg: expBg('expedition_templo_psiquico.webp', '#2a1a3a'),
  ...
  vulcao: {
    ...
    bg: expBg('expedition_vulcao.webp', '#3a1a0a'),
  ...
  selva_dragao: {
    ...
    bg: expBg('expedition_selva_dragao.webp', '#0a1a2a'),
  ...
  johto_ilex: {
    ...
    bg: expBg('bg_ilex_forest.webp', '#1a3a1a'), description: 'Madeira sagrada, Apricorns e essencias de Johto.',
  ...
  johto_whirl_islands: {
    ...
    bg: expBg('bg_ocean_routes.webp', '#0a2a4a'), description: 'Cavernas marinhas para coletar recursos aquaticos raros.',
  ...
  hoenn_meteor_falls: {
    ...
    bg: expBg('bg_meteor_falls.webp', '#1a1a2a'), description: 'Minerios, poeira mistica e fragmentos de meteorito.',
  ...
  hoenn_sky_pillar: {
    ...
    bg: expBg('bg_sky_pillar.webp', '#0a1a2a'), description: 'Expedicao de elite para escamas, penas e materiais draconicos.',
  ...
  sinnoh_mt_coronet: {
    ...
    bg: expBg('bg_mt_coronet.webp', '#2a2a2a'), description: 'Nucleo mineral de Sinnoh com drops para forja avancada.',
  ...
  sinnoh_stark_mountain: {
    ...
    bg: expBg('bg_mt_coronet.webp', '#3a1a0a'), description: 'Area pos-Liga para materials de boss e treino de nivel 100.',
  ...
  unova_pinwheel: {
    ...
    bg: expBg('expedition_unova_pinwheel.webp', '#14532d'), description: 'Estrutura preparada para Unova e quinta geracao.',
  ...
  kalos_reflection_cave: {
    ...
    bg: expBg('expedition_kalos_reflection.webp', '#7c3aed'), description: 'Estrutura preparada para Kalos e sexta geracao.',
  ...
  alola_akala: {
    ...
    bg: expBg('expedition_alola_akala.webp', '#0ea5e9'), description: 'Estrutura preparada para Alola e setima geracao.',
  ...
  galar_wild_area: {
    ...
    bg: expBg('expedition_galar_wildarea.webp', '#16a34a'), description: 'Estrutura preparada para Galar e oitava geracao.',
  ...
  paldea_area_zero: {
    ...
    bg: expBg('expedition_paldea_areazero.webp', '#22d3ee'), description: 'Estrutura preparada para Paldea e nona geracao.',
