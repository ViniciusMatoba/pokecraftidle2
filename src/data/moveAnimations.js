...
export const TYPE_FX = {
  ...
  Bug:      { sprite: 'web',          color: '#88ff44' },
  Poison:   { sprite: 'poisonwisp',   color: '#cc44cc' },
  Steel:    { sprite: 'gear',         color: '#aaaacc' },
...
export const MOVE_ANIMATIONS = {
  ...
  // ── STATUS / SUPORTE ────────────────────────────
  'growl':           { type: 'pulse',             sprite: 'sound',        color: '#dddddd', count: 3, duration: 380 },
  'leer':            { type: 'pulse',             sprite: 'stare',        color: '#ff5555', count: 2, duration: 360 },
  'tail-whip':       { type: 'pulse',             sprite: 'shine',        color: '#dddddd', count: 2, duration: 340 },
  'swords-dance':    { type: 'pulse',             sprite: 'sword',        color: '#ffffff', count: 4, duration: 460 },
  'harden':          { type: 'pulse',             sprite: 'shine',        color: '#aaaacc', count: 2, duration: 360 },
  'iron-defense':    { type: 'pulse',             sprite: 'gear',         color: '#ccccff', count: 3, duration: 420 },
  'agility':         { type: 'pulse',             sprite: 'shine',        color: '#aaccff', count: 3, duration: 380 },
  'thunder-wave':    { type: 'projectile_trail',  sprite: 'electroball',  color: '#ffff44', count: 4, duration: 430 },
  'will-o-wisp':     { type: 'projectile_trail',  sprite: 'wisp',         color: '#aa66ff', count: 4, duration: 430 },
  'poison-powder':   { type: 'projectile_trail',  sprite: 'poisonwisp',   color: '#cc44cc', count: 5, duration: 460 },
  'sleep-powder':    { type: 'projectile_trail',  sprite: 'petal',        color: '#88ccff', count: 5, duration: 460 },
  'stun-spore':      { type: 'projectile_trail',  sprite: 'poisonwisp',   color: '#ffee66', count: 5, duration: 460 },
  'protect':         { type: 'pulse',             sprite: 'shine',        color: '#ffffff', count: 3, duration: 420 },
  'recover':         { type: 'pulse',             sprite: 'heart',        color: '#66ff99', count: 4, duration: 480 },
  'synthesis':       { type: 'pulse',             sprite: 'shine',        color: '#ffff66', count: 4, duration: 500 },
  'roost':           { type: 'pulse',             sprite: 'feather',      color: '#aaccff', count: 4, duration: 460 },
  'rain-dance':      { type: 'wave',              sprite: 'waterwisp',    color: '#44aaff', count: 5, duration: 560 },
  'sunny-day':       { type: 'burst',             sprite: 'shine',        color: '#ffcc44', count: 6, duration: 520 },
