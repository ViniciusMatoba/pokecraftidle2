...
export const ITEM_LABELS = {
  ...
  blue_apricorn: { icon: '🔵', name: 'Blue Apricorn' },
  green_apricorn: { icon: '🟢', name: 'Green Apricorn' },
  pink_apricorn: { icon: '🌸', name: 'Pink Apricorn' },
  red_apricorn: { icon: '🔴', name: 'Red Apricorn' },
  white_apricorn: { icon: '⚪', name: 'White Apricorn' },
  yellow_apricorn: { icon: '🟡', name: 'Yellow Apricorn' },
  black_apricorn_seed: { icon: '🌰', name: 'Semente de Apricorn Preto' },
  blue_apricorn_seed: { icon: '🌰', name: 'Semente de Blue Apricorn' },
  green_apricorn_seed: { icon: '🌰', name: 'Semente de Green Apricorn' },
  pink_apricorn_seed: { icon: '🌰', name: 'Semente de Pink Apricorn' },
  red_apricorn_seed: { icon: '🌰', name: 'Semente de Red Apricorn' },
  white_apricorn_seed: { icon: '🌰', name: 'Semente de White Apricorn' },
  yellow_apricorn_seed: { icon: '🌰', name: 'Semente de Yellow Apricorn' },
  ...
  oran_seed:         { icon: '🌱', name: 'Semente de Oran Berry' },
  sitrus_seed:       { icon: '🌱', name: 'Semente de Sitrus Berry' },
  lum_seed:          { icon: '🌱', name: 'Semente de Lum Berry' },
  cheri_seed:        { icon: '🌱', name: 'Semente de Cheri Berry' },
  chesto_seed:       { icon: '🌱', name: 'Semente de Chesto Berry' },
  pecha_seed:        { icon: '🌱', name: 'Semente de Pecha Berry' },
  rawst_seed:        { icon: '🌱', name: 'Semente de Rawst Berry' },
  aspear_seed:       { icon: '🌱', name: 'Semente de Aspear Berry' },
  leppa_seed:        { icon: '🌱', name: 'Semente de Leppa Berry' },
  // Ração
