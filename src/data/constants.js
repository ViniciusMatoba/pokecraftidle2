...
export const ITEM_LABELS = {
  ...
  moon_stone_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/moon-stone.png',    name: 'Fragmento de Lua' },
  fire_stone_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/fire-stone.png',    name: 'Fragmento de Fogo' },
  water_stone_shard:  { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/water-stone.png',   name: 'Fragmento de Água' },
  leaf_stone_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/leaf-stone.png',    name: 'Fragmento de Folha' },
  thunder_stone_shard:{ icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/thunder-stone.png', name: 'Fragmento de Trovão' },
  sun_stone_shard:    { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/sun-stone.png',     name: 'Fragmento Solar' },
  shiny_stone_shard:  { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/shiny-stone.png',   name: 'Fragmento Brilhante' },
  dusk_stone_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/dusk-stone.png',    name: 'Fragmento Crepuscular' },
  dawn_stone_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/dawn-stone.png',    name: 'Fragmento da Alvorada' },
  ice_stone_shard:    { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/ice-stone.png',     name: 'Fragmento de Gelo' },
  magmarizer_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/magmarizer.png',    name: 'Fragmento de Magmarizer' },
  electirizer_shard:  { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/electirizer.png',   name: 'Fragmento de Eletrizador' },
  kings_rock_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/kings-rock.png',    name: 'Fragmento de Coroa Real' },
  reaper_cloth_shard: { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/reaper-cloth.png',  name: 'Fragmento do Manto Sombrio' },
  metal_coat_shard:   { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/metal-coat.png',    name: 'Fragmento de Casaco Metálico' },
  prism_scale_shard:  { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/prism-scale.png',   name: 'Fragmento de Escama Prisma' },
  link_cable_part:    { icon: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/up-grade.png',      name: 'Peça de Cabo Link' },
