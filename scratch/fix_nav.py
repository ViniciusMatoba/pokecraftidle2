...
path = r'c:\Users\Usuario\Desktop\pokecraftidle2-master\src\AppRoot.jsx'
with open(path, 'r', encoding='utf-8') as f:
    content = f.read()

target = """      {(!loading && user && gameState.worldFlags?.includes('has_starter')) && (
...
replacement = """      {(!loading && user && gameState.worldFlags?.includes('has_starter')) && (
