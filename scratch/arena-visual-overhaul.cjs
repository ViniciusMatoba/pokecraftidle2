...
const oldArena = `      <div className="relative overflow-hidden rounded-2xl shadow-xl flex-shrink-0" style={{ height: 220 }}>
              ...
              <>
                <div className="flex justify-between items-center gap-2 mb-1">
                   <span className="font-black text-[10px] uppercase text-slate-800 truncate max-w-[120px]">
                      {currentEnemy.isTrainer ? \`\${currentEnemy.trainerName}'s \${currentEnemy.name}\` : currentEnemy.name}
        ...
        <div className="absolute bottom-2 left-2 z-10 flex flex-col items-start gap-1 max-w-[160px]">
          {activePoke ? (
            <>
