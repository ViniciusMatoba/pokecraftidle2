...
// <div className="flex gap-2 px-2 flex-shrink-0">...</div>
...
content = content.replace(autoCaptureSearch, autoCaptureSection);
...
console.log('Cleaned up BattleScreen UI and integrated Auto-Capture config');
